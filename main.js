  ...
  async function uploadFile(file) {
    ...
    try {
      ...
      <div style="display: inline-flex; align-items: center; gap: 8px; vertical-align: middle;">
        <span style="color:#34c759; font-size:14px; line-height: 1; vertical-align: middle;">上传成功</span>
        <button class="reply-small-btn del-btn" onclick="clearMedia()" style="vertical-align: middle;">移除</button>
      </div>
      `;
    } catch (err) {
      let errMsg = "上传失败，请重试";
